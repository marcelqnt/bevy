...
fn apply_pbr_lighting(
    ...
    for (var i: u32 = clusterable_object_index_ranges.first_spot_light_index_offset;
            i < clusterable_object_index_ranges.first_bar_light_index_offset;
            i = i + 1u) {
        let light_id = clustering::get_clusterable_object_id(i);        
    ...
    // Bar lights (direct)
    for (var i: u32 = clusterable_object_index_ranges.first_bar_light_index_offset;
        ...
        // Bar lights always contribute diffuse in this project setup.
        let enable_diffuse = true;
